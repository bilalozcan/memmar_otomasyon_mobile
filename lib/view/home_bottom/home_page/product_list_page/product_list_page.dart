...
class _ProductListPageState extends BaseState<ProductListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:!context.watch<ProductListViewModel>().wait!?ListView.builder(
        itemCount: context.read<ProductListViewModel>().productList.length,
        itemBuilder: (BuildContext context, int index) {
          return Card(
            color: context.read<ProductListViewModel>().productList[index].isActive==1?Colors.white:Colors.grey.withOpacity(0.1),
            child: Padding(
